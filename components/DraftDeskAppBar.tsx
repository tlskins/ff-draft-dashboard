...
const DraftDeskAppBar = ({
  ...
  return (
    <header className={`${styles.desk} ${styles.surface} hidden w-full items-center justify-between gap-3 px-4 py-2 text-left md:flex`}>
      <div className="min-w-0">
        <p className="text-base font-bold tracking-wide">Drafty</p>
        <p className={`${styles.muted} text-xs`}>Integrated draft desk</p>
      </div>
